...
import kgcLogo from '../assets/dapp.svg'
...
const Balance = () => {
    ...
    // Subscribe to the deposit event we wrote in exchange.sol 
    // [x] Step 1. do deposit
    // [x] Step 2. Notify app that deposit is pending
    // [x] Step 3. Get confirmation that deposit was successful
    // [] Step 4. Notify app that deposit was successsful
        ...
        <div className='component exchange__transfers'>
            ...
            <div className='exchange__transfers--form'>
                <div className='flex-between'>
                    <p><small>Token</small><br /><img src={kgcLogo} alt="KGC Logo" />{symbols && symbols[0]}</p>
            ...
            <div className='exchange__transfers--form'>
                <div className='flex-between'>
                    <p><small>Token</small><br /><img src={ethLogo} alt="ETH Logo" />{symbols && symbols[1]}</p>
