...
describe('Exchange', () => {
    ...
    beforeEach(async () => {
        ...
        token1 = await Token.deploy('Kyle Guad Coin', 'KGC', '1000000')
    ...
    describe('Making orders', () => {
        let transaction, result, amount = tokens(1)
        ...
        describe('Failure', () => {
            it('Rejects with no balance', async () => {
                await expect(exchange.connect(user1).makeOrder(token2.address, tokens(1), token2.address, tokens(1)))
            })
        })
    })
